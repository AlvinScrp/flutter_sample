...
import 'package:flutter_sample/flutter_widget_from_html_core/src/ops/build_ops.dart';
import 'package:html/dom.dart' as dom;

import 'core_helpers.dart';
import 'core_html_widget.dart';
import 'node_meta_data.dart';
import 'text/text_bit.dart';
...
part 'ops/style_box.dart';

part 'ops/style_transform.dart';
...
//  BuildOp _styleMargin;
  ...
  Widget buildPadding(Widget child, EdgeInsets padding) =>
      child != null && padding != null && padding != const EdgeInsets.all(0)
          ? Container(child: child, padding: padding)
          : child;

  Widget buildMargin(Widget child, EdgeInsets margin) =>
      child != null && margin != null && margin != const EdgeInsets.all(0)
          ? Container(child: child, margin: margin)
          : child;
  ...
  double buildTextLetterSpacing(
      TextStyleBuilders tsb, TextStyle p, NodeMetadata m) {
    final value = m.letterSpacing;
    if (value == null) return null;
  ...
  TextStyle buildTextStyle(TextStyleBuilders tsb, TextStyle p, NodeMetadata m) {
    ...
    final letterSpacing = buildTextLetterSpacing(tsb, p, m);
...
//        meta = lazySet(meta, buildOp: styleBgColor());
        meta = lazySet(meta, buildOp: styleBox());
        break;
      case kCssColor:
      ...
      case kCssFontSize:
        ...
        break;
      case kCssLetterSpacing:
        meta = lazySet(meta, letterSpacing: value);
        break;
      ...
      case kCssMarginTop:
//        meta = lazySet(meta, margin: parseCssMargin(key, value));
//        meta = lazySet(meta, buildOp: styleMargin());
      ...
      case kCssBorder:
        ...
        break;
      case kCssTransform:
        meta = lazySet(meta, buildOp: styleTransform());
        break;
  ...
  BuildOp styleBox() {
    _styleBox ??= _StyleBox(this).buildOp;
    return _styleBox;
  }

  BuildOp styleTransform() {
    _styleTransform ??= _StyleTransform(this).buildOp;
